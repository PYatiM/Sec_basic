...
# Character pools (global for shared access)
pool = {
...
left = int(input("Enter left seed value: "))
right = int(input("Enter right seed value: "))
length = int(input("Enter desired password length (>= 4): "))

password = password_generate(left, right, length)
